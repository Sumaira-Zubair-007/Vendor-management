...
<html lang="en">
  ...
  <div class="mt-3">
     <table class="table table-bordered" id="users-list">
       ...
       <tr>
             <td> Cost</td>
             <td><?php echo $proposal[0]['cost']; ?></td>
             <td><?php echo $proposal[1]['cost']; ?></td>
             <td><?php echo $benchmark['cost']; ?></td>
       </tr>
       <tr>
             <td> Time</td>
             <td><?php echo  $proposal[0]['time']?></td>
             <td><?php echo $proposal[1]['time']; ?></td>
             <td><?php echo $benchmark['time']; ?></td>
       </tr>
       <tr>
             <td>  Quality </td>
             <td><?php echo $proposal[0]['quality'] ?></td>
             <td><?php echo $proposal[1]['quality']; ?></td>
             <td><?php echo $benchmark['quality']; ?></td>
       </tr>
