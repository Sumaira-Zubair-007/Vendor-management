...
<html lang="en">
  ...
  <body class="nav-md">
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Vendor Management</span></a>
            </div>
    ...
    <div class="">
        <a href="<?php echo base_url('/public/proposal-form') ?>" class="btn btn-success mb-2"> Create Proposal</a>
	</div>
    <?php
     ...
     <table class="table table-bordered" id="users-list">
       ...
       <tbody>
          ...
          <tr>
             ...
             <td><?php echo $pro['proposal_name']; ?></td>
             <td><?php echo $pro['time']; ?></td>
             <td><?php echo $pro['cost']; ?></td>
             <td><?php echo $pro['quality']; ?></td>
             <td>
              <a href="<?php echo base_url('edit-view/'.$pro['id']);?>" class="btn btn-primary btn-sm">Edit</a>
              <a href="<?php echo base_url('delete/'.$pro['id']);?>" class="btn btn-danger btn-sm">Delete</a>
              </td>
          </tr>
         <?php endforeach; ?>
         <?php endif; ?>
